function pageEvents() {
    ...
    $("#anc_add").click(function () {
           ...
           {
               $('#tbl1 tr:eq(' + cnt + ')').first().after('<tr><td>Point of Contact ' + cnt + '</td><td> <input type="text" placeholder="name2" name="pocName[]"></td><td> <input type="text" placeholder="Email id" name="email2' + val + '"></td></tr>');
               cnt++;
               val++;
           }
           j++;
