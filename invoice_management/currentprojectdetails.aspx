...
<div id="dashboard_layout">
    ...
    <div id="dashboard_setting">
        ...
        <asp:Button ID="btnback" ClientIDMode="Static" runat="server" Text="Back" CausesValidation="false" OnClick="btnback_Click" />
        <div id="delete">
             <asp:Button ID="btndelete" runat="server" CssClass="btnstyle" Text="Delete"  OnClick="btndelete_Click" OnClientClick="return confirmDelete()" />
        </div>
     
       
        
        <div id="setting">
            <asp:Button ID="btnedit" CssClass="btnstyle" runat="server" Text="Edit" OnClick="btnedit_Click"  />
        </div>
        <div id="logout">
   ...
   <div id="project_gridview">
    <asp:GridView ID="GridView1" CssClass="currentgrid" runat="server"  AutoGenerateColumns="False" AllowPaging="True"  
     OnRowEditing="GridView1_RowEditing" DataKeyNames="invoicenumber" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="4" OnPageIndexChanging="grdData_PageIndexChanging">
    <Columns>
        ...
        <PagerStyle CssClass="gridpaging" />
          ...
          <asp:Panel runat="server" ID="pnlnoinvoice" Visible="false" CssClass="noinvoicecss" ClientIDMode="Static">
             <asp:Label runat="server"  ID="lblnoinvoice" Text="You have not raised any invoices yet" ></asp:Label>
                </asp:Panel>
    </div>
    <div id="hours">
       <table cellspacing="10px">
