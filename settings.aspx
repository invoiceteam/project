    ...
    <div class="tabl">
        <div class="setting">
            ...
            <div class="align">
                ...
                <div><asp:Label ID="label2" runat="server" Text="Technology"></asp:Label> </div>
                <div class="pwd">
                ...
                <div><asp:Label ID="label4" runat="server" Text="Types of Project"></asp:Label> </div>
                 <div class="pwd">
                   <table style="border:0;padding:0;">
                        <tr>
                ...
                <div><asp:Label ID="label3" runat="server" Text="Period  of Invoice"></asp:Label> </div>
                <div class="pwd">
                     <table style="border:0;padding:0;">
                        <tr>
