...
public partial class Edit : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        if (ConfigurationManager.ConnectionStrings != null)
        {
            ...
            string poc = "select   poc_name from sample where project_id="+24;
            ...
            string sqlquery = "SELECT name FROM project WHERE hourly_rate = " + 15;
            SqlCommand command = new SqlCommand(sqlquery, con);
            TextBox2.Text = command.ExecuteScalar().ToString();
            TextBox2.DataBind();
            string sqlquery1 = "SELECT description FROM project WHERE hourly_rate = " + 15;
            ...
            //dropdown.DataBind();
            string cmd1 = "select technology from project where id=ID";
            ...
            string assgn = "select finance_assignee from project where id=ID";
    ...
    {
        SqlConnection sqlConn = new SqlConnection(@"Server=AMX-534-PC; Database=invoice; User Id=sa; password= sa5");


        sqlConn.Open();
        string query = @"UPDATE project SET name=@name,technology=@technology, type=@type, description=@description,period_of_invoice=@period_of_invoice, finance_assignee=@finance_assignee,start_date=@start_date, end_date=@end_date,total_rate=@total_rate,hourly_rate=@hourly_rate,project_status=@project_status,total_budget=@total_budget OUTPUT INSERTED.ID WHERE id=14 ";
